namespace OswalMRA
{
    partial class frmNewMould
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel8.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25.23306F));
            tableLayoutPanel8.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 24.6555F));
            tableLayoutPanel8.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 24.88818F));
            tableLayoutPanel8.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25.22326F));
            ...
            btnAddNew.Location = new Point(111, 3);
